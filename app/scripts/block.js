...
$(document).ready(function () {
    ...
    var fader = function () {
        ...
        clone
            .addClass('clone')
            .css({'top': offset.top, 'left': offset.left, width: that.width()})
            .bind('click', function () {})
            .prependTo(blocks)
        ...
        $('.fadout', clone).bind('click', function () {
            ...
            clone.animate({ top: offset.top, left: offset.left,
                           width: that.width(), height: that.height()}, 800, 'swing', function () {
                clone.remove();
            });
